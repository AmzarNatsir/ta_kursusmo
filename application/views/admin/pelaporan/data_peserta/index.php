                    ...
                    <div class="card">
                        ...
                        <table class="table table-bordered">
                            ...
                            ?>
                                <tr>
                                    <td><?php echo $nom;?></td>
                                    <td><img src="<?php echo base_url()?>assets/upload/peserta/<?php echo $dt['file_photo'] ?>" alt="produk" class="widget-image img-circle pull-left animation-fadeIn" style="width: 80px; height: 80px"></td>
